  ...
  return (
    <div>
      <div className="p-7 h-screen flex flex-col justify-between">
        ...
        <div>
          <img className="w-16 mb-4" src={logocap} alt="Logo" />
          <form
            onSubmit={(e) => {
              SubmitHandler(e);
            }}
          >
            ...
            />
            <button className="bg-[#10b461] text-white font-semibold mb-5 rounded-lg px-4 py-2 w-full text-lg">
              Login
            </button>
          </form>
        ...
        <div>
          <p className="text-[14.5px] leading-tight text-gray-500">
